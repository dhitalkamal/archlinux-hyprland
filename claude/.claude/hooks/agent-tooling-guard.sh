...
protected_prefixes=(
    "$HOME/Projects/archlinux-hyprland/claude/.claude/hooks/"
    "$HOME/Projects/archlinux-hyprland/claude/.claude/agents/"
    "$HOME/Projects/archlinux-hyprland/claude/.claude/settings.json"
    "$HOME/Projects/archlinux-hyprland/claude/.claude/CLAUDE.md"
    "$HOME/.claude/hooks/"
